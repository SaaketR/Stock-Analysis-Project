...
namespace WindowsFormsApp_COP_4365
{
    internal class Recognizer_Neutral : Recognizer
    {
        ...
        public override bool Recognize(List<SmartCandlestick> scsList, int index)
        {
            ...
            {
                bool neutral = scs.bodyRange < (scs.range * 0.03m);     // condition for neutral candlestick
                scs.Dictionary_Pattern.Add(Pattern_Name, neutral);      // adding to pattern dictionary
                return neutral;
            }
        }
    }
